...
<div class="wrap J_check_wrap">
  <div class="nav">
    <ul class="cc">
      <li class="current"><a href="<?php echo U('post/recyclebin');?>">文章回收</a></li>
    </ul>
  </div>
  <div class="h_a">搜索</div>
  <form  method="post" action="<?php echo u('post/recyclebin');?>">
  ...
  <form class="J_ajaxForm" action="" method="post">
      ...
      <table width="100%">
        ...
        <thead>
        	...
        	<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
		            ...
		            <td>
		            	<a href="<?php echo U('post/restore',array('term'=>empty($term['term_id'])?'':$term['term_id'],'id'=>$vo['tid']));?>" class="J_ajax_dialog_btn"  data-msg="确定还原吗？">还原</a>|
		            	<a href="<?php echo U('post/clean',array('term'=>empty($term['term_id'])?'':$term['term_id'],'tid'=>$vo['tid'],'id'=>$vo['ID']));?>" class="J_ajax_del" >删除</a>
					</td>
    ...
    <div>
      <div class="btn_wrap_pd">
        ...
        <button class="btn J_ajax_submit_btn" type="submit" data-action="<?php echo u('post/clean');?>" data-subcheck="true" data-msg="你确定删除吗？">删除</button>
      </div>
    </div>
  </form>
</div>
