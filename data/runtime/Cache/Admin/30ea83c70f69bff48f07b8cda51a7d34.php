...
<div class="wrap J_check_wrap">
  <div class="nav">
    <ul class="cc">
      ...
      <li class="current"><a href="<?php echo U('post/add',array('term'=>$term['term_id']));?>">添加文章</a></li>
    </ul>
  </div>
  <form name="myform" id="myform" action="<?php echo u('post/add_post');?>" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
